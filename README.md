...
- 📁 \*해당 프로젝트 링크로 확인하기 (🔗 https://github.com/CHOIJEONGAN/CHOIJEONGAN/tree/main/TPJT_1st)\_
...
- **맡은 파트**: 프로젝트 방향 설정 및 데이터 수집 및 분석, ppt 제작
- 📁 \*해당 프로젝트 링크로 확인하기 (🔗 https://github.com/CHOIJEONGAN/CHOIJEONGAN/tree/main/TPJT_2nd)\_
...
- 📁 \*해당 프로젝트 링크로 확인하기 (🔗 https://github.com/CHOIJEONGAN/StoreSales.git)\_
- 📁 \*스트림릿 대시보드 링크로 확인하기 (🔗 https://choijeongan-storesales-app-wamkhm.streamlit.app)\_
...
- **주제**: 금리
- 📁 \*해당 프로젝트 링크로 확인하기 (🔗 https://github.com/CHOIJEONGAN/CHOIJEONGAN/tree/main/PPJT_CJA)\_
